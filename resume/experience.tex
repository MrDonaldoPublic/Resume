  ...
  \cventry
    ...
    {Sep. 2023 - Current} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {\textbf{Architected and executed a critical system consolidation} by migrating legacy C++/Go services to a unified Java platform, successfully merging the "News" and "Dzen" codebases to streamline ownership for the engineering team. Enhanced API usability and developer experience by designing a custom automation tool that programmatically integrates Swagger/OpenAPI annotations.}
        % \item {\textbf{Enhanced API usability and developer experience by designing a custom automation tool that programmatically integrates Swagger/OpenAPI annotations and embeds Swagger-UI directly into the service admin panel, eliminating manual documentation overhead.}
      \end{cvitems}
    }
